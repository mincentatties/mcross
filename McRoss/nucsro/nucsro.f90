...
REAL(8)            :: sumdsq, conc, c, laue, olddsq, r, q, ii_level
...
!  Title
    ...
    CALL nucsro_run_params(conc,aflg,simflg,n,ii_level,norm)

!------------------------------------------------------------------------
! Read In Data
    IF (.NOT. simflg) CALL read_data(aflg, numd)
...
SUBROUTINE NucSRO_run_params(conc,aflg,simflg,numtot,ii_level,norm)
